...
\begin{table*}[t]
	\centering
	\caption{Differences in memorability, believability, and desirability for different conditions of the trip or traveller. A green background denotes cases where there was a statistically significant difference within that condition where $\alpha = 0.05$, and a yellow background denotes cases where $\alpha = 0.1$}
