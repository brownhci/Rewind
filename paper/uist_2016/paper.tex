...
\section{Findings}
% upper-bound estimates of event-related memories.  <-- april - found this without the beginning of its sentence. where does this fragment belong?
...
Within-subject comparison in our study reveals that participants are significantly better at recalling semantic memory of a particular location with Rewinds than with static street-view photos, $\chi^2(1, 356) = 96.987$, $p < 0.01$. When being presented with a street-side photo, participants were able to recognize places visited 50\% of the time; yet recognition rate of locations reached 97\% when participants played accompanying Rewinds. It should not be too surprising that cinematic media like a Rewind would provide participants with more contextual meanings and retrival cues for semantic processing, as more than one participant have expressed their contentment after wathing \textit{Rewind} videos by claiming ``I recognize the photo now!'' when their initial attempts with static images were fruitless. 

It could possibly be inferred that participants are likely to benefit more from \textit{Rewind} videos than static street-view images at recalling episodic memory. Although participants were not explicitly asked about trip remembrance when presented with static images, location rememberance from static images may serve as an upper-bound estimation of how much an individual could recall about a particular trip. %- tbc
