...
\begin{abstract}
GPS tracking using smartphones have been prevalent, providing self-trackers insights into their past visits and traveling patterns. Using tracked GPS information, we proposed \textit{Rewind}, a system that recreates sceneries of past trips to assist the recall of episodic memory. \textit{Rewind} takes historical GPS data from the users, maps out movement trajectories, and generates stitched-together videos to simulate the ways how past trips were taken. Users of \textit{Rewind} can change their moving directions by scrubbing their pointers over the video. Images used in \textit{Rewind} videos are post-processed to reveal weather and timely characteristics of the emulated environment.  Our study of self-trackers using two-week of GPS data with \textit{Rewind} has revealed that non-GPS users tend to think \textit{Rewind} videos have accurately captured their past trips, and users are particularly interested in preserving \textit{Rewind} videos of infrequent trips and trips accompanied by others. Overall, \textit{Rewind} serves as an experiment of the extreme scenario where people can freely roam and experience the world, keeping their mobile devices in their pockets, and still generate believable representations that capture the past.
\end{abstract}
