...
\begin{enumerate}
\item Memorability: How would \textit{Rewind} facilitate with the retrival of episodic memory? What types of users are most likely to recall their memories using \textit{Rewind}?
...
\item GPS usage: how self-identified regular GPS users and non-regular GPS users differ in their responses to \textit{Rewind} vidoes.
\item Traveller type: how self-identified frequent travellers and non-frequent travellers report to the three measurements of \textit{Rewind} vidoes differently.
\item Companions: how travelling companionship and solitude affect users' viewpoints on \textit{Rewind} vidoes.
\item Distance: how travelling distances affect users' perceptions of \textit{Rewind} vidoes.
\item Visit frequency: how visit frequency of a particular place influence users' reporting on \textit{Rewind} vidoes.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
